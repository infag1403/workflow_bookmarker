...
def main():
    """
    Simple test script to verify detection of different windows of the same application.
    
    Instructions:
    1. Run this script
    2. Open multiple windows of the same application (e.g., multiple Terminal windows)
    3. Switch between these windows
    4. The script will print detailed information about each window change
    5. Press Ctrl+C to exit
    """
    print("\n=== Same App Window Detection Test ===")
    ...
    if last_window:
        print(f"Initial window: {last_window.get('app')} - {last_window.get('title')}")
